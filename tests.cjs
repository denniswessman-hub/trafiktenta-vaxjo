...
assert.equal(ids.length,171);assert.equal(new Set(ids).size,171);
...
console.log('PASS: 171 exercises (65 primary + 61 legacy + 45 quick quiz), all TBL sections and 31 exception questions, teacher/source labels, 20 images and offline assets, exact multi-answer scoring, saved selections/checklists, legacy migration, repetition intervals, invalid imports, licence boundaries, version/encoding.');
